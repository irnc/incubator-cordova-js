...
/* If readyState is not 'loading' then it is either 'interactive' or 'complete',
 * which means that it is equivalent to DOMContentLoaded, so fire respective
 * Cordova event.
 *
 * NOTE: readyState can also be 'loaded' in legacy WebKit, see link below
 *
 * @link https://github.com/oyvindkinsey/easyXDM/pull/47
 * @author irnc
 */
if (document.readyState !== 'loading') {
    channel.onDOMContentLoaded.fire();
    /* Disable onDOMContentLoaded to prevent double firing in case that this
     * code is running after document.readyState is set to 'interactive' but
     * before 'DOMContentLoaded' event.
     *
     * TODO: find in specification why this is not possible
     */
    channel.onDOMContentLoaded.enabled = false;
}
